...
Each **MetalLB** or **OpenPERouter** QE skill is self-contained with these directories so operational rules and execution helpers live alongside the skill that uses them.
